...
<div class="form-group">
    ...
    <div class="col-sm-2">
        {{Form::text('limit_stock',  $item->limit_stock,array('class'=>'form-control','id'=>'limit_stock'))}}
    </div>
</div>
<div class="form-group">
...
<script type="text/javascript">
    ...
    $('#btnSave').click(function () {
        ...
        $.ajax({
            type: "post",
            url: base_url + index_page + "mis/backend/hsware/group/edit/{{$item->id}}",
            ...
            success: function (data) {
                if (data.error.status == false) {
                    ...
                    window.location.href = base_url + index_page + "mis/backend/hsware/group";
                }
            }
        });
    });
