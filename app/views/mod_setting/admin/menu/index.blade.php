    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="javascript:;" rel="setting/backend/menu/add/0" class="btn btn-primary link_dialog" title="เพิ่ม Menu" role="button"><i class="fa fa-plus"></i> เพิ่ม Menu</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#domain-list").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": base_url + index_page + "setting/backend/menu/listall",
            "order": [[5, 'asc']],
            "columnDefs": [{
                    "targets": "_all",
                    "defaultContent": ""
