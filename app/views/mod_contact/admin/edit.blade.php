...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {{ \Form::select('contact_id', array('' => 'กรุณาเลือกบริษัท') + $contact_list, $item->contact_id, array('class' => 'form-control', 'id' => 'contact_id')); }}
    </div>
</div>
<div class="form-group">
    {{Form::label('fullname', 'ชื่อ-นามสกุล', array('class' => 'col-sm-3 control-label req'))}}
    <div class="col-sm-8">
        {{Form::text('fullname', $item->fullname,array('class'=>'form-control','id'=>'fullname'))}}
    </div>
</div>
<div class="form-group">
    {{Form::label('position', 'ตำแหน่ง', array('class' => 'col-sm-3 control-label'))}}
    <div class="col-sm-6">
        {{Form::text('position', $item->position,array('class'=>'form-control','id'=>'position'))}}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        {{Form::text('mobile', $item->mobile,array('class'=>'form-control','id'=>'mobile'))}}
    </div>
</div>
<div class="form-group">
