    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="javascript:;" rel="mis/hsware/group/model/sub/add/{{\Request::segment(6)}}" class="btn btn-primary link_dialog" title="เพิ่มรุ่น" role="button"><i class="fa fa-plus"></i> เพิ่มรุ่น (F8)</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#group-list").dataTable({
            ...
            "serverSide": true,
            "pageLength": 25,
            "ajax": base_url + index_page + "mis/hsware/group/model/sub/listall/{{\Request::segment(6)}}",
            "columnDefs": [{
                    "targets": "_all",
                    "defaultContent": ""
                }],
