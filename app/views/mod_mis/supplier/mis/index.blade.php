    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="javascript:;" rel="mis/supplier/add" class="btn btn-primary link_dialog" title="เพิ่ม Supplier" role="button"><i class="fa fa-plus"></i> เพิ่ม Supplier (F8)</a>
                        <a href="javascript:;" rel="mis/supplier/contact/add" class="btn btn-primary" role="button"><i class="fa fa-user-plus"></i> เพิ่มผู้ติดต่อ</a>
                    </div>
                </div>
            </div>
        </div>
