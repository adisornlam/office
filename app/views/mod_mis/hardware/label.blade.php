    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="{{URL::to('mis/backend/hardware/label/add')}}" class="btn btn-primary" role="button"><i class="fa fa-plus"></i> เพิ่มสเปคอุปกรณ์</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#users-list").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": base_url + index_page + "mis/backend/hardware/label/listall",
            "columnDefs": [{
                    "targets": "_all",
                    "defaultContent": ""
                }],
            "columns": [
                ...
                {"data": "cat_title", "title": "หมวดหมู่", "width": "30%", "orderable": false, "searchable": true}
            ]
        });
    });
