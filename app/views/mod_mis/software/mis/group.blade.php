    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="{{\URL::to('mis/software/group/add')}}" class="btn btn-primary" title="สร้างกลุ่ม Software" role="button"><i class="fa fa-plus"></i> สร้างกลุ่ม Software</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#group-list").dataTable({
            ...
            "serverSide": true,
            "pageLength": 25,
            "ajax": base_url + index_page + "mis/software/group/listall",
            "columnDefs": [{
                    "targets": "_all",
                    "defaultContent": ""
                }],
            "columns": [
                ...
                {"data": "title", "title": "รายการ", "width": "70%", "orderable": false, "searchable": true},
