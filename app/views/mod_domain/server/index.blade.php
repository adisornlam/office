    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-body">
                <div class="pull-left">
                    <div class="btn-group">
                        <a href="javascript:;" rel="domain/backend/server/add" class="btn btn-primary link_dialog" title="เพิ่ม Server" role="button"><i class="fa fa-plus"></i> เพิ่ม Server</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#domain-list").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": base_url + index_page + "domain/backend/server/listall",
            "columnDefs": [{
                    "targets": "_all",
                    "defaultContent": ""
                }],
            "columns": [
                ...
                {"data": "server_title", "title": "Server", "width": "40%", "orderable": false, "searchable": true},
                {"data": "server_expire", "title": "วันก่อนหมด(วัน)", "sClass": "text-center", "width": "10%", "orderable": false, "searchable": true},
                {"data": "server_expire_date", "title": "วันหมดอายุ", "sClass": "text-center", "width": "10%", "orderable": false, "searchable": true},
