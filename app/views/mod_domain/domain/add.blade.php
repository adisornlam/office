...
<div class="form-group">
    {{Form::label('company', 'บริษัท', array('class' => 'col-sm-3 control-label'));}}
    <div class="col-sm-5">
        {{ \Form::select('company_id', array('' => 'กรุณาเลือกบริษัท') + $company, null, array('class' => 'form-control', 'id' => 'company_id')); }}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {{ \Form::select('server_id', array('' => 'กรุณาเลือก Server (ถ้ามี)') + $server, null, array('class' => 'form-control', 'id' => 'server_id')); }}
    </div>
</div>
<div class="form-group">
