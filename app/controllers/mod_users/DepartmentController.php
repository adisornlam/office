...
class DepartmentController extends \BaseController {
    ...
    public function index() {
        ...
        if (\Auth::check()) {
            if ($check->is('administrator')) {
                return \View::make('mod_users.admin.department.index', $data);
            } elseif ($check->is('employee')) {
                
            }
        } else {
            return \View::make('mod_users.guest.department', $data);
        }
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            return \View::make('mod_users.admin.department.add');
        } else {
            $rules = array(
                'title' => 'required',
                'weight' => 'integer'
    ...
    public function sub_add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_users.admin.department.sub_add', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_users.admin.department.edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function sub_edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_users.admin.department.sub_edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
