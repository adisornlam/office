...
class MenuController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('mod_setting.admin.menu.index', $data);
    }
    ...
    public function sub($id = 0) {
        ...
        return \View::make('mod_setting.admin.menu.sub', $data);
    }
    ...
    public function add($id = 0) {
        if (!\Request::isMethod('post')) {
            return \View::make('mod_setting.admin.menu.add');
        } else {
            $rules = array(
                'title' => 'required',
                'url' => 'required',
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_setting.admin.menu.edit', $data);
        } else {
            $rules = array(
                'title' => 'required',
                'url' => 'required',
