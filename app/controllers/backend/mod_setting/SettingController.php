...
class SettingController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('backend.mod_domain.domain.index', $data);
    }
    ...
    public function listall() {
        ...
        $link .= '<li><a href="javascript:;" rel="domain/backend/edit/{{$id}}" class="link_dialog" title="แก้ไขรายการ"><i class="fa fa-pencil-square-o"></i> แก้ไขรายการ</a></li>';
        $link .= '<li><a href="javascript:;" rel="domain/backend/delete/{{$id}}" class="link_dialog delete" title="ลบรายการ"><i class="fa fa-trash"></i> ลบรายการ</a></li>';
        $link .= '</ul>';
        $link .= '</div>';
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_domain.domain.add', $data);
        } else {
            $rules = array(
                'title' => 'required',
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_domain.domain.edit', $data);
        } else {
            $rules = array(
                'title' => 'required',
                'expire_date' => 'required'
