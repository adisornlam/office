...
class CategoryController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('backend.mod_mis.hardware.category', $data);
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            return \View::make('backend.mod_mis.hardware.category_add');
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.category_edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
