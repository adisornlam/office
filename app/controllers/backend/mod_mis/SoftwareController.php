...
class SoftwareController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('backend.mod_mis.software.index', $data);
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.software.equipment_add', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.software.equipment_edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
