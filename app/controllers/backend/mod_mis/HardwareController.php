...
class HardwareController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('backend.mod_mis.hardware.index', $data);
    }
    ...
    public function dialog() {
        ...
        return \View::make('backend.mod_mis.hardware.equipment_dialog_add', $data);
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.equipment_add', $data);
        } else {
            $rules = array(
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.equipment_edit', $data);
        } else {
            $rules = array(
                'category_id' => 'required',
                'title' => 'required',
    ...
    public function label() {
        ...
        return \View::make('backend.mod_mis.hardware.label', $data);
    }
    ...
    public function label_view($param) {
        ...
        return \View::make('backend.mod_mis.hardware.label_view', $data);
    }
    ...
    public function label_add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.label_add', $data);
        } else {
            $rules = array(
                'category_id' => 'required'
            );
    ...
    public function label_edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.label_edit', $data);
        } else {
            $rules = array(
                'category_id' => 'required'
            );
    ...
    public function spec_label_add($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.label_dialog_add', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function spec_label_edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_mis.hardware.label_dialog_edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
