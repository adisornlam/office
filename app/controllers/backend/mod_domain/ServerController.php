...
class ServerController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('backend.mod_domain.server.index', $data);
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_domain.server.add', $data);
        } else {
            $rules = array(
                'title' => 'required',
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('backend.mod_domain.server.edit', $data);
        } else {
            $rules = array(
                'title' => 'required',
                'expire_date' => 'required'
