...
class ContactController extends \BaseController {
    ...
    public function index() {
        ...
        return \View::make('mod_contact.admin.index', $data);
    }
    ...
    public function add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_contact.admin.add', $data);
        } else {
            $rules = array(
                'fullname' => 'required'
            );
    ...
    public function edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_contact.admin.edit', $data);
        } else {
            $rules = array(
                'fullname' => 'required'
            );
    ...
    public function group() {
        ...
        return \View::make('mod_contact.admin.group', $data);
    }
    ...
    public function group_add() {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_contact.admin.group_add', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
    ...
    public function group_edit($param) {
        if (!\Request::isMethod('post')) {
            ...
            return \View::make('mod_contact.admin.group_edit', $data);
        } else {
            $rules = array(
                'title' => 'required'
            );
